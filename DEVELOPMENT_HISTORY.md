# Teenio Web development history

This document preserves the detailed development and verification record previously
kept in the README, covering work through **v0.7.1 (23 September 2026)**. Test counts
and hardware-check results belong to the milestones described; earlier results
are retained as history, not claims that every feature is fully verified today.

For a short introduction and the app launch button, see the [README](README.md).
The operational notes below also cover [local development](#run-locally) and
[publishing an update](#publish-an-update-on-github).
...
## Development and verification record — through v0.7.1
